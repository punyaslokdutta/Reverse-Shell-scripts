# Most accessible is the header file located in /usr/include/i386-linux-gnu/asm/unistd_43.h.
# This file lists out all the syscall values for anything you could need, including the ones listed above. 
# It will be clear as we’re writing the bind shell program when we utilize these syscall values
